...
pub async fn install_plugin(lang: &Lang) -> Result<CacheMap<String, ()>, RunProcessError> {
...
pub async fn install_language_version(lang: &Lang, version: &str) -> Result<(), RunProcessError> {
    println!(

...
impl Unpin for LimitedAsyncPipe {}

pub struct LimitedAsyncPipeOutput {
    value: Vec<u8>,
...
impl Future for LimitedAsyncPipe {
    type Output = std::io::Result<LimitedAsyncPipeOutput>;
